...
def lambda_handler(frt: FaasitRuntime):
    ...
    store.put(params['output']['vectors_pca'], vectors,dest_state=['stage1'])
    store.put(params['output']['train_pca_transform'], first_n_A_label, dest_state=['stage1', 'stage2', 'stage3'])
